...
@section('ver-semana')
    ...
    <h3>Abajo podras ver los temas de las siguientes 6 semanas:</h3>
        ...
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Derivadas e Integrales" style="margin-bottom:20px" data-content="La derivada de una función, se puede interpretar geométricamente como la pendiente de la curva de la función matemática f(x) trazada en función de x.    En Cambio la  integral de una función se puede interpretar geométricamente como el área bajo la curva de una función matemática f(x) trazada como una función de x." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Programacion Web" style="margin-bottom:20px" data-content="Desarrollo web es un término que define la creación de sitios web para Internet o una intranet. Para conseguirlo se hace uso de tecnologías de software del lado del servidor y del cliente que involucran una combinación de procesos de base de datos con el uso de un navegador web a fin de realizar determinadas tareas o mostrar información." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Circuitos integrados" style="margin-bottom:20px" data-content="Un circuito integrado (CI), también conocido como chip o microchip, es una estructura de pequeñas dimensiones de material semiconductor, normalmente silicio, de algunos milímetros cuadrados de superficie (área), sobre la que se fabrican circuitos electrónicos generalmente mediante fotolitografía y que está protegida dentro de un encapsulado de plástico o de cerámica.​ El encapsulado posee conductores metálicos apropiados para hacer conexión entre el circuito integrado y un circuito impreso." style="margin-bottom:10px;width:200px">Ver Descripción</button>        
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Python" style="margin-bottom:20px" data-content="Python es un lenguaje de programación interpretado cuya filosofía hace hincapié en una sintaxis que favorezca un código legible. Se trata de un lenguaje de programación multiparadigma, ya que soporta orientación a objetos, programación imperativa y, en menor medida, programación funcional. Es un lenguaje interpretado, usa tipado dinámico y es multiplataforma." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="C#" style="margin-bottom:20px" data-content="C# (pronunciado si sharp en inglés) es un lenguaje de programación orientado a objetos desarrollado y estandarizado por Microsoft como parte de su plataforma .NET, que después fue aprobado como un estándar por la ECMA (ECMA-334) e ISO (ISO/IEC 23270). C# es uno de los lenguajes de programación diseñados para la infraestructura de lenguaje común." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="VisualBasics" style="margin-bottom:20px" data-content="Visual Basic (VB) es un lenguaje de programación dirigido por eventos, desarrollado por Alan Cooper para Microsoft. Este lenguaje de programación es un dialecto de BASIC, con importantes agregados. Su primera versión fue presentada en 1991, con la intención de simplificar la programación utilizando un ambiente de desarrollo." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Bases de Datos" style="margin-bottom:20px" data-content="Una base de datos es un conjunto de datos pertenecientes a un mismo contexto y almacenados sistemáticamente para su posterior uso. En este sentido; una biblioteca puede considerarse una base de datos compuesta en su mayoría por documentos y textos impresos en papel e indexados para su consulta." style="margin-bottom:10px;width:200px">Ver Descripción</button>
        ...
        <button type="button" class="btn btn-dark" onclick="window.location.href='/verreflexion'" style="margin-bottom:20px">Ver Reflexiones</button>
        <button type="button" class="btn btn-dark" onclick="window.location.href='/vercitas'" style="margin-bottom:20px">Ver Citas</button>
        <button type="button" class="btn btn-primary" data-toggle="popover" title="Eliminar Campos" style="margin-bottom:20px" data-content="MySQL pone a nuestra disposición el comando DELETE, que usaremos del siguiente modo: DELETE FROM tabla WHERE condición. Algo que podríamos leer como “borra de la tabla indicada aquello que cumpla cierta condición”." style="margin-bottom:10px;width:200px">Ver Descripción</button>
